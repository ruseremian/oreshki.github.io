...
export function LegalFooter() {
  return (
    <footer className="border-t border-cocoa/10 bg-cream/65">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-5 px-4 py-8 text-center text-sm text-cocoa/65 sm:flex-row sm:px-6 sm:text-left lg:px-8">
